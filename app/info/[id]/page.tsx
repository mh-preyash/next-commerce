...
export default function Page() {
  ...
  return (
    <div className="mx-auto max-w-2xl bg-white px-6 pt-6 lg:max-w-7xl">
      {/* Image gallery */}
      <div className="mt-6 sm:px-6 lg:grid lg:grid-cols-3 lg:gap-x-8 lg:px-8">
      ...
      {/* Product info */}
      <div className=" px-6 pb-16 pt-10 sm:px-6 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
